...
public class Job {
    ...
    //  the 'id' field.
    public Job() { //1st constructor which initializes the id field
        id = nextId;
        nextId++;
    }

    public Job(String name, Employer employer, Location location, PositionType positionType, CoreCompetency coreCompetency) { //2nd constructor
        this();
        this.name =name;
